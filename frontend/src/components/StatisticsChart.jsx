        ...
        <div
          className={
            loading
              ...
              : "w-full flex justify-center items-center text-red-900"
          }
        >
          {loading ? t("loading_chart") : error}
        </div>
      ) : (
        <div className="w-full overflow-hidden rounded-xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-[#11131f] shadow-sm p-6">
