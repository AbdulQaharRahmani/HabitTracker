...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (sampleUser.userEmail === email && sampleUser.userPassword === password) {
                alert("Success! 🎉")
                navigate("/")
            } else {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#F0F8FF' }}>
            ...
            <div className="bg-white p-10 rounded-[2rem]  w-full max-w-md shadow-[0_20px_50px_rgba(123,104,238,0.2),_0_-10px_30px_rgba(0,212,170,0.1)] hover:shadow-[0_30px_60px_rgba(123,104,238,0.3),_0_-10px_30px_rgba(0,212,170,0.15)]
        transition-all" style={{ borderColor: '#7B68EE' }}>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    <fieldset disabled={loading} className="space-y-5">
                        ...
                        <div className="relative ">
                            ...
                            >
                                {passwordType === "password" ? <FaEyeSlash size={22} /> : <FaEye size={22} />}
                            </button>
                        </div>
